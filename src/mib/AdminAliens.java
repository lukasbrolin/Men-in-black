...
public class AdminAliens extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblAgentIkon.setLabelFor(pnlBorderTop);
        ...
        btnRaderaAlien.setBackground(new java.awt.Color(255, 255, 255));
        btnRaderaAlien.setFont(new java.awt.Font("Open Sans Semibold", 0, 14)); // NOI18N
        btnRaderaAlien.setText("Radera Alien");
        btnRaderaAlien.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        btnRaderaAlien.setContentAreaFilled(false);
        btnRaderaAlien.setMaximumSize(new java.awt.Dimension(75, 30));
        btnRaderaAlien.setMinimumSize(new java.awt.Dimension(75, 30));
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlFonsterLayout.createSequentialGroup()
                                .addGroup(pnlFonsterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlFonsterLayout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addGroup(pnlFonsterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(txtDat1)
                                            .addComponent(cmbRas, 0, 180, Short.MAX_VALUE)
                                            .addComponent(cmbPLats, 0, 180, Short.MAX_VALUE))
                                        .addGap(33, 33, 33)
                                        .addGroup(pnlFonsterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(pnlFonsterLayout.createSequentialGroup()
                                                .addComponent(chkDatum2)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(txtDat2, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE))
                                            .addComponent(btnListaAlla, javax.swing.GroupLayout.PREFERRED_SIZE, 225, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlFonsterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlFonsterLayout.createSequentialGroup()
                ...
                .addGroup(pnlFonsterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlFonsterLayout.createSequentialGroup()
                        .addGroup(pnlFonsterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(pnlFonsterLayout.createSequentialGroup()
                                .addGroup(pnlFonsterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(cmbPLats, javax.swing.GroupLayout.DEFAULT_SIZE, 45, Short.MAX_VALUE)
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(pnlFonsterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(chkDatum, javax.swing.GroupLayout.DEFAULT_SIZE, 29, Short.MAX_VALUE)
                            .addComponent(chkDatum2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(txtDat2)
                            .addComponent(txtDat1, javax.swing.GroupLayout.Alignment.TRAILING)))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlFonsterLayout.createSequentialGroup()
                        .addGroup(pnlFonsterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(btnRegistreraAlien, javax.swing.GroupLayout.DEFAULT_SIZE, 74, Short.MAX_VALUE)
                            .addComponent(btnAndraAlien, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(pnlFonsterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(btnTomFalt, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(btnRaderaAlien, javax.swing.GroupLayout.DEFAULT_SIZE, 41, Short.MAX_VALUE))))
                .addGap(32, 32, 32)
                .addComponent(pnlBorderBottom, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(pnlFonster, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    private void btnRegistreraAlienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistreraAlienActionPerformed
        ...
        if(Validation.isNotEmpty(txtAlienID) && Validation.isNotEmpty(txtAnsvarigAgent) && Validation.isNotEmpty(txtNamn) && Validation.isNotEmpty(txtPlats) && Validation.isNotEmpty(txtRas) && Validation.isNotEmpty(txtRegistrering) && Validation.isNotEmpty(txtTelefon) && Validation.isCorrectDateFormat(txtRegistrering) && Validation.isPlats(txtPlats) && Validation.isRas(txtRas) && Validation.isHeltal(txtAlienID) && Validation.isTelefon(txtTelefon) && Validation.isAgent(txtAnsvarigAgent)&& !Validation.existingID(txtAlienID, "alien"))
        {    
        try{
    ...
    //Om användaren klickar ja på optionpanen och en rad är markerad i tabellen så tas den markerade alienen bort från alientabellen och från rätt rastabell som är sparad i Stringen valRas.
    private void btnRaderaAlienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRaderaAlienActionPerformed
        int optionPane = JOptionPane.showConfirmDialog(null, "Vill du radera alien?", "Radera alien" , JOptionPane.YES_NO_OPTION);
        if(optionPane == JOptionPane.YES_OPTION)
        {
            if(Validation.isNotSelectedjTable(tblAliens))   
                try
                {    
                    int selectedRow = tblAliens.getSelectedRow();
                    String fragan = "";
                    String fragan2 = "";
                    fragan2 = "DELETE FROM " + tblAliens.getValueAt(selectedRow, 5) + " WHERE ALIEN_ID = " + tblAliens.getValueAt(selectedRow, 0);
                    fragan = "DELETE FROM ALIEN WHERE ALIEN_ID = " + tblAliens.getValueAt(selectedRow, 0);
                    InfDB databas = DataBaseConnection.getDB();
                    String rasReset = "DELETE FROM " + valdRas + " WHERE ALIEN_ID = " + tblAliens.getValueAt(selectedRow, 0);
    ...
    private void btnAndraAlienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAndraAlienActionPerformed
       if(Validation.isNotEmpty(txtAlienID) && Validation.isNotEmpty(txtAnsvarigAgent) && Validation.isNotEmpty(txtNamn) && Validation.isNotEmpty(txtPlats) && Validation.isNotEmpty(txtRas) && Validation.isNotEmpty(txtRegistrering) && Validation.isNotEmpty(txtTelefon) && Validation.isCorrectDateFormat(txtRegistrering) && Validation.isPlats(txtPlats) && Validation.isRas(txtRas) && Validation.isHeltal(txtAlienID) && Validation.isTelefon(txtTelefon) && Validation.isAgent(txtAnsvarigAgent))
        {    
        try{
            String losen = "";
            String nyttID = txtAlienID.getText();
